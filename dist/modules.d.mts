...
//#region src/modules/stream/types.d.ts
...
//#endregion
//#region src/modules/stream/config/stream.config.d.ts
/**
 * Configuration options for the StreamConfig
 */
type StreamConfig = {
  /** Name of the NATS stream */streamName: string; /** Storage type for the stream (memory or file) */
  streamStorage: StorageType; /** Retention policy for messages in the stream */
  streamRetention: RetentionPolicy; /** Policy for discarding messages when limits are reached */
  streamDiscard: DiscardPolicy; /** Maximum number of consumers allowed for this stream (-1 for unlimited) */
  streamMaxConsumers?: number; /** Maximum age of messages in seconds before they are removed (0 for unlimited) */
  streamMaxAgeSeconds?: number; /** Maximum size of the stream in megabytes */
  streamMaxSizeMB: number;
};
//#endregion
//#region src/modules/stream/classes/common.class.d.ts
type Options = {
  /** Name of the NATS stream */streamName: string; /** Name of the NATS consumer */
  consumerName?: string; /** Flag to enable/disable debug logging */
  debug: boolean;
};
declare class Common {
  protected readonly core: JetstreamClient$1;
   ...
   */
  constructor(core: JetstreamClient$1, options: Options);
...
type PublisherOptions = {
  /** Flag to enable/disable debug mode */debug?: boolean;
};
/**
...
//#endregion
//#region src/modules/stream/config/consumer.config.d.ts
/**
 * Configuration options for the ConsumerConfig
 */
type ConsumerConfig = {
  /** Name of the NATS stream */streamName: string; /** Name of the consumer */
  consumerName: string; /** Subject filter for the consumer */
  consumerFilterSubject?: string; /** Policy for delivering messages to the consumer */
  consumerDeliverPolicy?: DeliverPolicy; /** The maximum number of messages without acknowledgement that can be outstanding, once this limit is reached message delivery will be suspended */
...
type ConsumerOptions = {
  /** Maximum number of concurrent message processing operations */maxConcurrent: number; /** Flag to enable/disable debug logging */
  debug?: boolean;
};
/**
